...
function resta_cubos (a,b) {return Math.abs(a[0]*a[1]*a[2] - b[0]*b[1]*b[2])}

console.assert(resta_cubos([2,2,7], [5,4,2]) , "Error");
console.assert(resta_cubos([2,2,2], [3,3,3]) , "Error");